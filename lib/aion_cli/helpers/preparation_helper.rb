...
module AionCLI
  module PreparationHelper
    ...
    def validate_cpr(cpr)
      ...
      cpr_regex = /^(?:(?:31(?:0[13578]|1[02])|(?:30|29)(?:0[13-9]|1[0-2])|(?:0[1-9]|1[0-9]|2[0-8])(?:0[1-9]|1[0-2]))[0-9]{2}-?[0-9]|2902(?:[468][048]|[579][26])-?[49]|2902(?:[02468][048]|[13579][26])-?[0-3])[0-9]{3}|000000-?0000$/
      !!cpr.match(cpr_regex)
    end
